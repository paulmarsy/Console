Invoke-InstallStep "Configuring Console Visual Studio Integration" {
	...
	New-ItemProperty "HKCU:\Software\Microsoft\VisualStudio\12.0\DialogPage\GrzegorzKozub.VisualStudioExtensions.ConEmuLauncher.Options" "Path" -Value $PowerShellConsoleContstants.Executables.ConEmu -Type String -Force | Out-Null
