Invoke-InstallStep "Configuring Command Prompt Console Hook" {
	...
	New-ItemProperty "HKCU:\Software\Microsoft\Command Processor" "AutoRun" -Value $PowerShellConsoleContstants.HookFiles.CommandPrompt -Type String -Force | Out-Null
}