try {
    ...
    if (# Microsoft Azure PowerShell  https://github.com/Azure/azure-powershell
        ...
        (Invoke-Installer -Name "SmartGit" -Uri "http://www.syntevo.com/downloads/smartgit/smartgit-win32-setup-jre-6_5_7.zip" -Optional -Type exe -Zipped -ArgumentList ($innoInstallerArguments + @('/MERGETASKS="!desktopicon"'))) -and `
